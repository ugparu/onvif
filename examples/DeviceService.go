...
import (
	...
	goonvif "github.com/ugparu/onvif/lib"
	sdk "github.com/ugparu/onvif/sdk/device"
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/ugparu/onvif/gosoap for pretty printing response
