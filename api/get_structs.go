...
import (
	...
	"github.com/ugparu/onvif/device"
	"github.com/ugparu/onvif/event"
	"github.com/ugparu/onvif/media"
	"github.com/ugparu/onvif/ptz"
)

func getEventStructByName(name string) (any, error) {
	switch name {
	...
	case "SetSynchronizationPoint":
		return &event.SetSynchronizationPoint{}, nil
	case "CreatePullPointSubscription":
		return &event.CreatePullPointSubscription{}, nil
	case "PullMessages":
		return &event.PullMessages{}, nil
	case "Unsubscribe":
